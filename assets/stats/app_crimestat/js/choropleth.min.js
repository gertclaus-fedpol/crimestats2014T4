...
c.DE.Export="Exporteer gegevens (.CSV-formaat)";c.DE.ExportHelp="* Kopieer bv. in Excel";c.DE.NoData="Confidenti\u00eble gegevens";c.DE.Metadata="Download metadata-fiche";return a}();a.map=function(){function e(){"normal"==a.viz.mode&&(a.viz.scope.select(".compass").show(),a.viz.scope.select(".body").on("mouseover",function(){a.viz.scope.select(".compass").show()}).on("mouseout",function(){a.viz.scope.select(".compass").hide()}))}function c(a){queue();d3.json("maps/topo.json",function(d){d3.keys(d.objects).forEach(function(a){b.geo[a]=
